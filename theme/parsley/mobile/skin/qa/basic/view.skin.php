...
<article id="bo_v">
	<div class="bo_v_innr">
	    ...
	    <section id="bo_v_info">
        	...
        	<?php if ($is_admin == 'super' || $is_auth || $update_href) {  ?>
        	<button class="bo_v_opt">
        		<span class="sound_only">게시물 옵션</span>
        ...
        <div id="bo_v_contact">
            ...
            <dl>
                ...
                <?php } ?>
                <?php if($view['hp']) { ?>
                <dt><i class="fas fa-phone"></i><span class="sound_only">휴대폰</span></dt>
