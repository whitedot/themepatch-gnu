...
// main full page
add_javascript('<script src="'.G5_THEME_JS_URL.'/jquery.fullpage.js"></script>', 1);
add_stylesheet('<link rel="stylesheet" href="'.G5_THEME_CSS_URL.'/jquery.fullpage.css">', 1);
add_javascript('<script src="'.G5_THEME_JS_URL.'/scrolloverflow.js"></script>', 1);
