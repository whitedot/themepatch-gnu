...
<aside id="poll" class="border_box">
	<h2>설문조사</h2>
    <div class="poll_cnt">
	...
	<?php if ($is_admin == "super") { ?><a href="<?php echo G5_ADMIN_URL ?>/poll_form.php?w=u&amp;po_id=<?php echo $po_id ?>" class="btn_admin"><i class="fa fa-cog"></i><span class="sound_only">관리자</span></a><?php } ?>
</aside>
</form>
