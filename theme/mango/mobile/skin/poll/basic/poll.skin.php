...
<div id="poll" class="box">
    <h2><i class="fa fa-pie-chart"></i> 설문조사</h2>
    <?php if ($is_admin == "super") { ?><a href="<?php echo G5_ADMIN_URL ?>/poll_form.php?w=u&amp;po_id=<?php echo $po_id ?>" class="btn_admin"><span class="sound_only">설문관리</span><i class="fa fa-cog" aria-hidden="true"></i></a><?php } ?>
    <div class="pl_wr">
